...
// providers/coze.js - provider for Coze (coze.com / coze.cn).
...
const VSProvider = VSGeneric({
  ...
  beta: false,
  selectors: {
    userItem: '[data-role="user"], [class*="user"][class*="message" i]',
    assistantItem: '[data-role="assistant"], [class*="assistant"][class*="message" i]',
