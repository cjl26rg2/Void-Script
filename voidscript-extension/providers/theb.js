...
// providers/theb.js - provider for TheB.AI (theb.ai).
...
const VSProvider = VSGeneric({
  ...
  beta: false,
  selectors: {
    userItem: '[class*="user-message" i], [class*="human" i], [data-role="user"]',
    assistantItem: '[class*="assistant-message" i], [class*="bot-message" i], [data-role="assistant"]',
