...
// providers/pi.js - BETA provider for Pi (pi.ai), Inflection's assistant.
...
const ZSProvider = ZSGeneric({
  ...
  selectors: {
    userItem: '[class*="user" i][class*="message" i], [data-author="user"]',
    assistantItem: '[class*="pi" i][class*="message" i], [class*="assistant" i][class*="message" i], .prose',
